...
- 修复 1.20.6 客户端加载时容器 tooltip mixin shadow 了不存在的方法导致 Mixin 应用失败的问题。
...
- 新建面向 Minecraft 1.20.6 的 Fabric 模组骨架，模组名为 `Amagari Translation Tool`，mod id 为 `amagari_translation_tool`。

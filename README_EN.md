...
- Translatable book text gets a hoverable `ⓘ` marker after the translated text; hovering the marker shows the source text on a light background close to the vanilla book page. Map-provided hover/click actions remain attached to the original text and do not trigger together with the ATT source box.

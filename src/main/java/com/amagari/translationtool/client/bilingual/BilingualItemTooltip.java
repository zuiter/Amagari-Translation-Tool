...
public final class BilingualItemTooltip {
	...
	private static void renderSourceTooltip(GuiGraphics graphics, Font font, ItemStack stack, List<Component> tooltipLines, List<Component> sourceText, int mouseX, int mouseY) {
	...
	private static int vanillaTooltipX(GuiGraphics graphics, int mouseX, int tooltipWidth) {
		int x = mouseX + 12;
	...
	private static void renderBox(GuiGraphics graphics, Font font, List<FormattedCharSequence> lines, int x, int y, int textWidth, int boxHeight) {

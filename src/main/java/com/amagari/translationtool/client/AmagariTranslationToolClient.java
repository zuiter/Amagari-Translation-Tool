...
public class AmagariTranslationToolClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ClientPlayNetworking.registerGlobalReceiver(ParaTranzCommandPayload.TYPE, (client, handler, buffer, responseSender) -> {
			ParaTranzCommandPayload payload = ParaTranzCommandPayload.read(buffer);
			client.execute(() -> handleParaTranzCommand(payload, client));
		});

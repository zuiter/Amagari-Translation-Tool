...
```text
amagari-translation-tool-mc1.21.4-fabric-0.2.0.jar
```
...
```text
build/libs/amagari-translation-tool-mc1.21.4-fabric-<version>.jar
```
...
- Artifact: 上传 `build/libs/amagari-translation-tool-mc1.21.4-fabric-<version>.jar`

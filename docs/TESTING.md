...
- In Minecraft 26.1, enter a singleplayer world after installing the mod and confirm the client reaches the world without disconnecting with a network protocol error while `BookViewScreen` is loaded.
